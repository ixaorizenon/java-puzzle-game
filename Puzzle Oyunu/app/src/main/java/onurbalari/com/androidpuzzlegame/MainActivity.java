...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            final String[] files = as.list("img");

            GridView grid = findViewById(R.id.grid);
            grid.setAdapter(new ImageAdapter(this));

            Intent gelenVeri = getIntent();
            int row = gelenVeri.getIntExtra("row",1);
            int col = gelenVeri.getIntExtra("col",1);
            int piecesNumber = gelenVeri.getIntExtra("piecesNumber",1);
            ...
            grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    intent.putExtra("piecesNumber",piecesNumber);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            Intent zrluk = new Intent(getApplicationContext(),Mod.class);
